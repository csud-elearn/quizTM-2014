...
project = u'Développement d\'une application web de création de quiz'
copyright = u'2014, Benoît Léo Maillard'
...
latex_documents = [
  ('index', 'Dveloppementduneapplicationwebdecrationdequiz.tex', u'Développement d\'une application web de création de quiz Documentation',
...
man_pages = [
    ('index', 'dveloppementduneapplicationwebdecrationdequiz', u'Développement d\'une application web de création de quiz Documentation',
